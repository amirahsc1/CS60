...
if(yourAmount <= myAmount){
    cout<<"I'm richer or we have the same amount" <<endl;
    }
if(yourAmount > myAmount){
    cout << "You're richer.\n" << endl;
    }
if(yourAmount >= myAmount){
    cout << "You're richer or we have the same amount" << endl;
    }
...
bool operator <=(const Money& amount1, const Money& amount2){
return ((amount1.dollars < amount2.dollars) || ((amount1.dollars == amount2.dollars) &&(amount1.cents < amount2.cents))||((amount1.dollars == amount2.dollars) && (amount1.cents == amount2.cents)));
};
bool operator >=(const Money& amount1, const Money& amount2){
return ((amount1.dollars > amount2.dollars) || ((amount1.dollars == amount2.dollars) &&(amount1.cents > amount2.cents))||((amount1.dollars == amount2.dollars) && (amount1.cents == amount2.cents)));
};
...
const Money Money::percent(int percentFigure) const {
    int totalMoney= (dollars*100+cents)*(percentFigure/100.0);
    int percentDollars = abs(totalMoney)/100;
    int percentCents= abs(totalMoney)%100;
    if(totalMoney <0){
        percentDollars = -percentDollars;
        percentCents = -percentCents;
    }
    return Money(percentDollars,percentCents);
